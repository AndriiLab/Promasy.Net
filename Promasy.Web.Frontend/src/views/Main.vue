...
import { MenuItem } from '@/components/AppSubmenu.vue';
...
const menu: MenuItem[] = [
    ...
    },
    {
        label: t('orgaization'),
        items: [
            { label: t('orgaizationList'), icon: 'pi pi-fw pi-building', to: '/orgaizations' },
            { label: t('departments'), icon: 'pi pi-fw pi-sitemap', to: '/departments' },
            { label: t('subdepartments'), icon: 'pi pi-fw pi-briefcase', to: '/subdepartments' },
...
<i18n locale="en">
{
    ...
    "suppliers": "Suppliers",
    "orgaization": "Orgaizations",
    "orgaizationList": "Orgaizations",
...
<i18n locale="uk">
{
    ...
    "orgaization": "Організації",
    "orgaizationList": "Організації",
    "departments": "Відділи",
